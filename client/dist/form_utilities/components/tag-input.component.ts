...
import {REACTIVE_FORM_DIRECTIVES, disableDeprecatedForms} from '@angular/forms';
...
@Component({
    ...
    directives: [FORM_DIRECTIVES, CORE_DIRECTIVES, TYPEAHEAD_DIRECTIVES, REACTIVE_FORM_DIRECTIVES]
})
